<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:insight  Version:1.8.2.0 - Mon Jul 02 09:51:25 CDT 2018 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Observational/pds:Observation_Area/pds:Mission_Area">
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'GeoCSV') and
      ...
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'GeoCSV') and
        (matches(insight:SEIS_Instrument_Parameters/insight:Metadata_Location/insight:metadata_file_name, '.+\.sxml'))
        ) or (
        not(insight:Observation_Information/insight:product_type = 'GeoCSV')
        ) )
      ">
        
        If the product_type is 'GeoCSV', then the class Metadata_Location must be present,
        and the value for metadata_file_name must end in '.sxml'.
      </sch:assert>
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'GeoCSV') and
        (matches(insight:SEIS_Instrument_Parameters/insight:SEED_Equivalent/insight:seed_file_name, '.+\.mseed'))
        ) or (
        not(insight:Observation_Information/insight:product_type = 'GeoCSV')
        ) )
      ">
        
        If the product_type is 'GeoCSV', then the class SEED_Equivalent must be present,
        and the value for seed_file_name must end in '.mseed'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Ancillary/pds:Context_Area/pds:Mission_Area">
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'StationXML') and
      ...
      ">
        ...
        If the product type is 'StationXML', then the class Metadata_Location must not be present.
      </sch:assert>
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'StationXML') and
        (matches(insight:SEIS_Instrument_Parameters/insight:SEED_Equivalent/insight:seed_file_name, '.+\.seed')) 
        ) or (
        not(insight:Observation_Information/insight:product_type = 'StationXML')
        ) )
      ">
        
        If the product type is 'StationXML', then the class SEED_Equivalent must be present,
        and the value for seed_file_name must end in '.seed'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Native/pds:Context_Area/pds:Mission_Area">
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'Mini-SEED') and
        (insight:SEIS_Instrument_Parameters/insight:seis_data_type = 'waveform')
        ) or (
      ...
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'Mini-SEED') and
        (matches(insight:SEIS_Instrument_Parameters/insight:Metadata_Location/insight:metadata_file_name, '.+\.seed'))
        ) or (
        not(insight:Observation_Information/insight:product_type = 'Mini-SEED')
        ) )
      ">
        
        If the product_type is 'Mini-SEED', then the class Metadata_Location must be present,
        and the value for metadata_file_name must end in '.seed'.
      </sch:assert>
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'Mini-SEED') and
        (matches(insight:SEIS_Instrument_Parameters/insight:ASCII_Equivalent/insight:ascii_equivalent_file_name, '.+A\.csv'))
        ) or (
        not(insight:Observation_Information/insight:product_type = 'Mini-SEED')
        ) )
      ">
        
        If the product_type is 'Mini-SEED', then the class ASCII_Equivalent must be present,
        and the value for ascii_equivalent_file_name must end in 'A.csv'.
      </sch:assert>
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'Dataless-SEED') and
          (insight:SEIS_Instrument_Parameters/insight:seis_data_type = 'metadata')
        ) or (
      ...
      ">
        ...
        If the product_type is 'Dataless-SEED', then the class Metadata_Location must not be present.
      </sch:assert>
      <sch:assert test="(
        ( (insight:Observation_Information/insight:product_type = 'Dataless-SEED') and
          (matches(insight:SEIS_Instrument_Parameters/insight:ASCII_Equivalent/insight:ascii_equivalent_file_name, '.+\.sxml'))
        ) or (
          not (insight:Observation_Information/insight:product_type = 'Dataless-SEED')
        ) )
      ">
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Observational/pds:Observation_Area/pds:Mission_Area/insight:SEIS_Instrument_Parameters">
      <sch:assert test="
        insight:Metadata_Location/pds:Internal_Reference/pds:reference_type = 'data_to_metadata'
      ">
        
        For a SEIS GeoCSV Product_Observational product, the Metadata_Location class 
        must be present, and the reference_type must be 'data_to_metadata'.
      </sch:assert>
      <sch:assert test="
        insight:SEED_Equivalent/pds:Internal_Reference/pds:reference_type = 'ascii_to_seed'
      ">
        
        For a SEIS GeoCSV Product_Observational product, the SEED_Equivalent class 
  ...
  <sch:pattern>
    <sch:rule context="pds:Product_Native/pds:Context_Area/pds:Mission_Area">
      ...
      ">
        ...
        For a SEIS Dataless-SEED Product_Native product, the class ASCII_Equivalent must be present,
        and the value for reference_type must be 'seed_to_ascii'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="pds:Product_Ancillary/pds:Context_Area/pds:Mission_Area/insight:SEIS_Instrument_Parameters">
      ...
      ">
        ...
        For a SEIS StationXML Product_Ancillary product, the SEED_Equivalent class 
        must be present, and the reference_type must be 'ascii_to_seed'.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
