<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:insight  Version:1.8.5.0 - Fri May 03 12:26:16 CDT 2019 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
      ...
      <sch:assert test="( 
                   (
                     (matches(insight:seis_waveform_type,'event')) 
                      and
                     (matches(/pds:Product_Observational/pds:File_Area_Observational/pds:File/pds:file_name,
                         '^[a-z|A-Z|0-9]+\.[a-z|A-Z|0-9]+\.[0-9]{2}\.[a-z|A-Z|0-9]{3}\.[0-9]{1,4}\.[0-9]{1,2}\.[A|a]\.csv$'))
                    )
                    or 
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Ancillary/pds:Context_Area/pds:Mission_Area">
      ...
      <sch:assert test="insight:SEIS_Instrument_Parameters/insight:SEED_Equivalent/pds:Internal_Reference/pds:reference_type =
        'ascii_to_seed' ">
      ...
      <sch:assert test="( 
                   (
                     (matches(insight:SEIS_Instrument_Parameters/insight:seis_waveform_type,'event')) 
                      and
                     (matches(/pds:Product_Native/pds:File_Area_Native/pds:File/pds:file_name,
                          '^[a-z|A-Z|0-9]+\.[a-z|A-Z|0-9]+\.[0-9]{2}\.[a-z|A-Z|0-9]{3}\.[0-9]{1,4}\.[0-9]{1,2}\.mseed$'))
                    )
                    or 
