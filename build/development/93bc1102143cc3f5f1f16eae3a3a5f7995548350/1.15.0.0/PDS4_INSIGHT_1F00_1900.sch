<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:insight  Version:1.9.0.0 - Thu Feb 12 19:29:28 UTC 2026 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Ancillary/pds:Context_Area/pds:Mission_Area">
      ...
      ">
        <title>/pds:Product_Ancillary/pds:Context_Area/pds:Mission_Area/Rule</title>
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Native/pds:Context_Area/pds:Mission_Area">
      ...
      ">
        <title>/pds:Product_Native/pds:Context_Area/pds:Mission_Area/Rule</title>
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Observational/pds:Observation_Area/pds:Mission_Area/insight:Observation_Information">
      ...
      ">
        <title>/pds:Product_Observational/pds:Observation_Area/pds:Mission_Area/insight:Observation_Information/Rule</title>
  ...
  <sch:pattern>
    <sch:rule context="/pds:Product_Observational/pds:Observation_Area/pds:Mission_Area/insight:SEIS_Instrument_Parameters">
      ...
      ">
        <title>/pds:Product_Observational/pds:Observation_Area/pds:Mission_Area/insight:SEIS_Instrument_Parameters/Rule</title>
  ...
  <sch:pattern>
    <sch:rule context="insight:ASCII_Equivalent/pds:Internal_Reference/pds:reference_type">
      <sch:assert test=". = ('seed_to_ascii')">
        <title>insight:ASCII_Equivalent/pds:Internal_Reference/pds:reference_type/insight:ASCII_Equivalent_Internal_Reference_reference_type</title>
        The attribute insight:ASCII_Equivalent/pds:Internal_Reference/pds:reference_type must be equal to the value 'seed_to_ascii'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="insight:Metadata_Location/pds:Internal_Reference/pds:reference_type">
      <sch:assert test=". = ('data_to_metadata')">
        <title>insight:Metadata_Location/pds:Internal_Reference/pds:reference_type/insight:Metadata_Location_Internal_Reference_reference_type</title>
        The attribute insight:Metadata_Location/pds:Internal_Reference/pds:reference_type must be equal to the value 'data_to_metadata'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="insight:Observation_Information/insight:mission_phase_name">
      <sch:assert test=". = ('ATLO', 'CRUISE', 'DEVELOPMENT', 'SURFACE MISSION', 'TEST')">
        ...
        The attribute insight:Observation_Information/insight:mission_phase_name must be equal to one of the following values 'ATLO', 'CRUISE', 'DEVELOPMENT', 'SURFACE MISSION', 'TEST'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="insight:SEED_Equivalent/pds:Internal_Reference/pds:reference_type">
      <sch:assert test=". = ('ascii_to_seed')">
        <title>insight:SEED_Equivalent/pds:Internal_Reference/pds:reference_type/insight:SEED_Equivalent_Internal_Reference_reference_type</title>
        The attribute insight:SEED_Equivalent/pds:Internal_Reference/pds:reference_type must be equal to the value 'ascii_to_seed'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:rule context="insight:SEIS_Instrument_Parameters/insight:seis_data_type">
      <sch:assert test=". = ('metadata', 'waveform')">
        ...
        The attribute insight:SEIS_Instrument_Parameters/insight:seis_data_type must be equal to one of the following values 'metadata', 'waveform'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="insight:SEIS_Instrument_Parameters/insight:seis_waveform_type">
      <sch:assert test=". = ('continuous', 'event')">
        ...
        The attribute insight:SEIS_Instrument_Parameters/insight:seis_waveform_type must be equal to one of the following values 'continuous', 'event'.</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
